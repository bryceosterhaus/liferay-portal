...
1.  Websocket Server "**NodeJS - Service Type**": A Node.js server will be utilized as a message exchange server for the chat application.

1.  Chat Widget - **"NG Web Component - Custom Element Type":** An Angular Web Component which communicates with LR Object API to post messages and connects to the Chat Server to get notified when messages arrive.