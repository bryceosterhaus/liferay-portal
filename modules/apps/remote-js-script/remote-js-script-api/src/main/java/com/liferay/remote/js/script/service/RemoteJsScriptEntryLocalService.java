...
/**
 * Provides the local service interface for RemoteJsScriptEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Bryce Osterhaus
 * @see RemoteJsScriptEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RemoteJsScriptEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.remote.js.script.service.impl.RemoteJsScriptEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the remote js script entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RemoteJsScriptEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
