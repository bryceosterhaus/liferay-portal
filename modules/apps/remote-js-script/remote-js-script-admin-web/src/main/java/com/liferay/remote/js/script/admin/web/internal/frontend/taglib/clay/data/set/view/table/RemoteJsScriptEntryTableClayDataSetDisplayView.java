...
package com.liferay.remote.js.script.admin.web.internal.frontend.taglib.clay.data.set.view.table;
...
@Component(
	immediate = true,
	property = "clay.data.set.display.name=" + RemoteJsScriptAdminConstants.REMOTE_JS_SCRIPT_ENTRY_DATA_SET_DISPLAY,
	service = ClayDataSetDisplayView.class
)
public class RemoteJsScriptEntryTableClayDataSetDisplayView
