...
/**
 * The persistence utility for the remote js script entry service. This utility wraps <code>com.liferay.remote.js.script.service.persistence.impl.RemoteJsScriptEntryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see RemoteJsScriptEntryPersistence
 * @generated
 */
public class RemoteJsScriptEntryUtil {
	 ...
	 */
	public static void clearCache(RemoteJsScriptEntry remoteJsScriptEntry) {
		getPersistence().clearCache(remoteJsScriptEntry);
	}
	 ...
	 */
	public static Map<Serializable, RemoteJsScriptEntry> fetchByPrimaryKeys(
	 ...
	 */
	public static List<RemoteJsScriptEntry> findWithDynamicQuery(
	 ...
	 */
	public static RemoteJsScriptEntry update(RemoteJsScriptEntry remoteJsScriptEntry) {
		return getPersistence().update(remoteJsScriptEntry);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static RemoteJsScriptEntry update(
		RemoteJsScriptEntry remoteJsScriptEntry, ServiceContext serviceContext) {

		return getPersistence().update(remoteJsScriptEntry, serviceContext);
	}
	 ...
	 */
	public static List<RemoteJsScriptEntry> findByUuid(String uuid) {
	 ...
	 */
	public static List<RemoteJsScriptEntry> findByUuid(
	 ...
	 */
	public static RemoteJsScriptEntry findByUuid_First(
			String uuid, OrderByComparator<RemoteJsScriptEntry> orderByComparator)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {
	 ...
	 */
	public static RemoteJsScriptEntry fetchByUuid_First(
		String uuid, OrderByComparator<RemoteJsScriptEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a matching remote js script entry could not be found
	 */
	public static RemoteJsScriptEntry findByUuid_Last(
			String uuid, OrderByComparator<RemoteJsScriptEntry> orderByComparator)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {
	 ...
	 */
	public static RemoteJsScriptEntry fetchByUuid_Last(
		String uuid, OrderByComparator<RemoteJsScriptEntry> orderByComparator) {
	 ...
	 */
	public static RemoteJsScriptEntry[] findByUuid_PrevAndNext(
			long remoteJsScriptEntryId, String uuid,
			OrderByComparator<RemoteJsScriptEntry> orderByComparator)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {

		return getPersistence().findByUuid_PrevAndNext(
			remoteJsScriptEntryId, uuid, orderByComparator);
	}
	 ...
	 * @return the matching remote js script entries
	 */
	public static List<RemoteJsScriptEntry> findByUuid_C(
	 ...
	 * @throws NoSuchEntryException if a matching remote js script entry could not be found
	 */
	public static RemoteJsScriptEntry findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<RemoteJsScriptEntry> orderByComparator)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {
	 ...
	 * @return the first matching remote js script entry, or <code>null</code> if a matching remote js script entry could not be found
	 */
	public static RemoteJsScriptEntry fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<RemoteJsScriptEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a matching remote js script entry could not be found
	 */
	public static RemoteJsScriptEntry findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<RemoteJsScriptEntry> orderByComparator)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {
	 ...
	 * @return the last matching remote js script entry, or <code>null</code> if a matching remote js script entry could not be found
	 */
	public static RemoteJsScriptEntry fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<RemoteJsScriptEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a remote js script entry with the primary key could not be found
	 */
	public static RemoteJsScriptEntry[] findByUuid_C_PrevAndNext(
			long remoteJsScriptEntryId, String uuid, long companyId,
			OrderByComparator<RemoteJsScriptEntry> orderByComparator)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {

		return getPersistence().findByUuid_C_PrevAndNext(
			remoteJsScriptEntryId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchEntryException if a matching remote js script entry could not be found
	 */
	public static RemoteJsScriptEntry findByC_U(long companyId, String url)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {
	 ...
	 */
	public static RemoteJsScriptEntry fetchByC_U(long companyId, String url) {
	 ...
	 * @return the matching remote js script entry, or <code>null</code> if a matching remote js script entry could not be found
	 */
	public static RemoteJsScriptEntry fetchByC_U(
	 ...
	 */
	public static RemoteJsScriptEntry removeByC_U(long companyId, String url)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {
	 ...
	 */
	public static void cacheResult(RemoteJsScriptEntry remoteJsScriptEntry) {
		getPersistence().cacheResult(remoteJsScriptEntry);
	}
	 ...
	 */
	public static void cacheResult(List<RemoteJsScriptEntry> remoteJsScriptEntries) {
		getPersistence().cacheResult(remoteJsScriptEntries);
	}
	 ...
	 */
	public static RemoteJsScriptEntry create(long remoteJsScriptEntryId) {
		return getPersistence().create(remoteJsScriptEntryId);
	}
	 ...
	 * @throws NoSuchEntryException if a remote js script entry with the primary key could not be found
	 */
	public static RemoteJsScriptEntry remove(long remoteJsScriptEntryId)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {

		return getPersistence().remove(remoteJsScriptEntryId);
	}

	public static RemoteJsScriptEntry updateImpl(RemoteJsScriptEntry remoteJsScriptEntry) {
		return getPersistence().updateImpl(remoteJsScriptEntry);
	}
	 ...
	 * @throws NoSuchEntryException if a remote js script entry with the primary key could not be found
	 */
	public static RemoteJsScriptEntry findByPrimaryKey(long remoteJsScriptEntryId)
		throws com.liferay.remote.js.script.exception.NoSuchEntryException {

		return getPersistence().findByPrimaryKey(remoteJsScriptEntryId);
	}
	 ...
	 */
	public static RemoteJsScriptEntry fetchByPrimaryKey(long remoteJsScriptEntryId) {
		return getPersistence().fetchByPrimaryKey(remoteJsScriptEntryId);
	}
	 ...
	 */
	public static List<RemoteJsScriptEntry> findAll() {
	 ...
	 */
	public static List<RemoteJsScriptEntry> findAll(int start, int end) {
	...
	public static RemoteJsScriptEntryPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<RemoteJsScriptEntryPersistence, RemoteJsScriptEntryPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			RemoteJsScriptEntryPersistence.class);

		ServiceTracker<RemoteJsScriptEntryPersistence, RemoteJsScriptEntryPersistence>
			serviceTracker =
				new ServiceTracker
					<RemoteJsScriptEntryPersistence, RemoteJsScriptEntryPersistence>(
						bundle.getBundleContext(),
						RemoteJsScriptEntryPersistence.class, null);
