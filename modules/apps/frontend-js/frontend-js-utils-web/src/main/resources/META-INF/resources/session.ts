...
class Session {
	...
	private _alert: any;
	private _alertpageTitle: string;
	...
	constructor(config: SessionConfig) {
		this._alertpageTitle = document.title;
	...
	private _uiSetRemainingTime(remainingTime: any, counterTextNode: any) {
		remainingTime = this._formatTime(remainingTime);

		if (!this._alertClosed) {
	...
	private _uiSetExpired() {
		if (this._banner) {
			...
			document.title = this._alertpageTitle;
		}
	}
