...
package com.liferay.remote.js.script.admin.web.internal.display.context;
 ...
 */
public class RemoteJsScriptAdminDisplayContext {

	public RemoteJsScriptAdminDisplayContext(
	...
	public CreationMenu getCreationMenu() {
		return CreationMenuBuilder.addDropdownItem(
			dropdownItem -> {
				...
				dropdownItem.setLabel(_getLabel("add-remote-js-script"));
			}
		).build();
	}
