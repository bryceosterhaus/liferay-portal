...
@Component(
	immediate = true,
	property = {
		"com.liferay.portlet.css-class-wrapper=portlet-remote-js-script-admin",
		...
		"javax.portlet.display-name=Remote JS Scripts",
...
public class RemoteJsScriptAdminPortlet extends MVCPortlet {
}